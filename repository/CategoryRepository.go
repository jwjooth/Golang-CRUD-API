...
type CategoryRepository interface {
	...
	Update(ctx context.Context, request *entities.Category)(*entities.CategoryEntity, error)
	Delete(ctx context.Context, id uint) bool
}
...
func (c *CategoryRepositoryImpl) GetById (ctx context.Context, id uint) (*entities.CategoryEntity, error){
	...
	if err := c.db.WithContext(ctx).First(category).Error; err != nil {
...
func (c *CategoryRepositoryImpl) Delete (ctx context.Context, id uint) bool {
